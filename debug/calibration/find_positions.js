 ...
 *   - vendor/yisim-master/lanke/talent_templates/        (talent PNGs per position)
 */
'use strict';
...
const TALENT_TEMPLATES_DIR = path.join(ROOT_DIR, 'vendor', 'yisim-master', 'lanke', 'talent_templates');
